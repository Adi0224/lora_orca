#!/usr/bin/env python3
"""
ORCA + LoRA Rank 4 (With Alignment)
"""
import sys
import os
import json
...
if __name__ == '__main__':
    ...
    print("="*70)
    print("  ORCA + LoRA RANK=4 (With Alignment)")
    print("="*70)
    print()
    ...
    with open('ORCA/src/configs/orca_r4.yaml', 'r') as f:
    ...
    try:
        ...
        with open('results/orca_r4_results.json', 'w') as f:
            json.dump(results, f, indent=2)

        print()
        print("="*70)
        print(f"✅ ORCA RANK=4 COMPLETE")
        print(f"  Test Accuracy: {test_acc*100:.2f}%")
        print(f"  Time: {elapsed:.1f}s")
        print(f"  Results saved to: results/orca_r4_results.json")
        print("="*70)
