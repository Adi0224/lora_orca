#!/usr/bin/env python3
"""
FPT + LoRA Rank 4 (Baseline: No Alignment)
"""
import sys
import os
import json
...
if __name__ == '__main__':
    ...
    print("="*70)
    print("  FPT + LoRA RANK=4 (Baseline: No Alignment)")
    print("="*70)
    print()
    ...
    with open('ORCA/src/configs/fpt_r4.yaml', 'r') as f:
    ...
    try:
        ...
        with open('results/fpt_r4_results.json', 'w') as f:
            json.dump(results, f, indent=2)

        print()
        print("="*70)
        print(f"✅ FPT RANK=4 COMPLETE")
        print(f"  Test Accuracy: {test_acc*100:.2f}%")
        print(f"  Time: {elapsed:.1f}s")
        print(f"  Results saved to: results/fpt_r4_results.json")
        print("="*70)
