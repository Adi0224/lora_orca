#!/usr/bin/env python3
"""
ORCA + LoRA Rank 2 (With Alignment)
"""
import sys
import os
import json
...
if __name__ == '__main__':
    ...
    print("="*70)
    print("  ORCA + LoRA RANK=2 (With Alignment)")
    print("="*70)
    print()
    ...
    with open('ORCA/src/configs/orca_r2.yaml', 'r') as f:
    ...
    print(f"  Objective: {args.objective} (WITH alignment)")
    ...
    try:
        ...
        with open('results/orca_r2_results.json', 'w') as f:
            json.dump(results, f, indent=2)

        print()
        print("="*70)
        print(f"✅ ORCA RANK=2 COMPLETE")
        print(f"  Test Accuracy: {test_acc*100:.2f}%")
        print(f"  Time: {elapsed:.1f}s")
        print(f"  Results saved to: results/orca_r2_results.json")
        print("="*70)
