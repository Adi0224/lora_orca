...
def get_optimizer_scheduler(args, model, module=None, n_train=1):
    if module is None:
        ...
        if use_lora:
            # LoRA mode: only train LoRA params + embedder + predictor
            # Unconditional freeze — avoids set_grad_state skipping position/tunable
            ...
            # Unfreeze embedder and predictor
